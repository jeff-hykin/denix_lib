...
export default nixFile(
  new URL("./licenses.nix", import.meta.url).pathname,
  ({ scope }) => (
    scope.func$({ lib: scope.nixArg$.NoDefault }, (scope) =>
      scope.let$({
        optionalAttrs: (scope) => scope.lib["optionalAttrs"],
        mkLicense: (scope) =>
          scope.func$("lname", (scope) =>
            scope.func$({
              shortName: (scope) => scope.lname,
              free: true,
              deprecated: false,
              spdxId: null,
              url: null,
              fullName: null,
              redistributable: (scope) => scope.free,
              ...
              scope.operators$.merge(
                scope.attrSet$({
                  ...
                  redistributable: () => scope.redistributable,
                  licenseType: "simple",
                }),
                scope.operators$.merge(
                  scope.apply$(
                    scope.optionalAttrs,
                    () => scope.operators$.hasAttr(scope.attrs, "spdxId"),
                    () =>
                      scope.attrSet$({
                        spdxId: () => scope.spdxId,
                        url: () =>
                  ...
                  scope.operators$.merge(
                    scope.apply$(scope.optionalAttrs, () =>
                      scope.operators$.hasAttr(scope.attrs, "url"), () =>
                      scope.attrSet$({
                        url: () =>
                          scope.url,
                      })),
                    scope.apply$(scope.optionalAttrs, () =>
                      scope.operators$.hasAttr(scope.attrs, "fullName"), () =>
                      scope.attrSet$({
                        fullName: () =>
                          scope.fullName,
                      })),
        ...
        scope.apply$(scope.lib["mapAttrs"], () =>
          scope.mkLicense, () => (scope.operators$.merge({
            ...
            asl11: { spdxId: "Apache-1.1", fullName: "Apache License 1.1" },
            asl20: { spdxId: "Apache-2.0", fullName: "Apache License 2.0" },
            baekmuk: { spdxId: "Baekmuk", fullName: "Baekmuk License" },
            bitstreamCharter: {
            ...
            buddy: { spdxId: "Buddy", fullName: "Buddy License" },
            bzip2: {
              spdxId: "bzip2-1.0.6",
            ...
            "cc-by-nd-30": {
              spdxId: "CC-BY-ND-3.0",
              fullName:
                "Creative Commons Attribution-No Derivative Works v3.00",
              free: false,
            },
            "cc-by-nd-40": {
              spdxId: "CC-BY-ND-4.0",
            ...
            cfitsio: { spdxId: "CFITSIO", fullName: "CFITSIO License" },
            ...
            gnuplot: { spdxId: "gnuplot", fullName: "gnuplot License" },
            gpl1Only: {
              spdxId: "GPL-1.0-only",
            ...
            "intel-eula": {
              ...
              url:
                "https://software.intel.com/sites/manageability/AMT_Implementation_and_Reference_Guide/WordDocuments/intelamtsdklicense.htm",
              free: false,
            },
            interbase: {
            ...
            json: { spdxId: "JSON", fullName: "JSON License", free: false },
            databricks: {
            ...
            lsof: { spdxId: "lsof", fullName: "lsof License" },
            miros: { spdxId: "MirOS", fullName: "MirOS License" },
            mit: { spdxId: "MIT", fullName: "MIT License" },
            "mit-click": { spdxId: "MIT-Click", fullName: "MIT Click License" },
            "mit-cmu": { spdxId: "MIT-CMU", fullName: "CMU License" },
            "mit-enna": { spdxId: "MIT-enna", fullName: "enna License" },
            ...
            mpich2: { spdxId: "mpich2", fullName: "mpich2 License" },
            mpl10: {
              spdxId: "MPL-1.0",
            ...
            netboxLimitedUse: {
              ...
              free: false,
              url:
                "https://github.com/netboxlabs/netbox-branching/blob/8465b9aee69ded23930cfe1a522695bfb8955a5a/LICENSE.md",
            },
            ngpl: {
              spdxId: "NGPL",
              fullName: "Nethack General Public License",
            },
            ngrep: { spdxId: "ngrep", fullName: "ngrep License" },
            nistSoftware: {
            ...
            ntp: { spdxId: "NTP", fullName: "NTP License" },
            nvidiaCuda: {
              shortName: "CUDA EULA",
            ...
            stk: { spdxId: "MIT-STK", fullName: "MIT-STK License" },
            sudo: {
              shortName: "sudo",
            ...
            tekHvcLicense: { spdxId: "TekHVC", fullName: "TekHVC License" },
            torque11: {
              spdxId: "TORQUE-1.1",
            ...
            wordnet: { spdxId: "WordNet", fullName: "WordNet License" },
            wtfpl: {
              spdxId: "WTFPL",
            ...
            x11BsdClause: {
              ...
              url:
                "https://gitlab.freedesktop.org/xorg/driver/xf86-video-geode/-/blob/d147c3f1b6907ae9db6f12853cedd450537d99d2/COPYING",
            },
            x11NoPermitPersons: {
              spdxId: "X11-no-permit-persons",
              fullName: "X11 no permit persons clause",
            },
            xerox: { spdxId: "Xerox", fullName: "Xerox License" },
