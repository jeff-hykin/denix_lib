...
export default nixFile(
  new URL("./deprecated.nix", import.meta.url).pathname,
  ({ scope }) => (
    scope.func$({ lib: scope.nixArg$.NoDefault }, (scope) =>
      scope.let$({
        ...
        compare: (scope) => scope.lib["compare"],
        ...
        closePropagationFast: (scope) =>
          scope.func$("list", (scope) =>
            scope.apply$(scope.builtins["map"], () =>
              scope.func$("x", (scope) =>
                scope.x["val"]), () =>
